        ...
        <a-list item-layout="horizontal" :data-source="paths">
            <a-list-item slot="renderItem" slot-scope="item">
                <a-list-item-meta :description="item.description">
                    <a slot="title"><a-icon type="line-chart"/>&nbsp;{{ item.name }}&nbsp;<a-button shape="circle" :icon="item.visible ? 'eye' : 'eye-invisible'" @click="_onVisibleButtonClick(item)"/><a-button shape="circle"></a-button><a-button shape="circle" icon="close" @click="_onCloseButtonClick(item)"/></a>
                </a-list-item-meta>
            </a-list-item>
        </a-list>
    </div>
