<template>
    <a-form @submit="handleSubmit" :form="form">
        ...
        <a-row class="form-row" :gutter="16" style="margin-top: 10px">
            <a-col :lg="12">
                <a-form-item label="定速精度" :labelCol="labelCol" :wrapperCol="wrapperCol">
...
export default {
    ...
    methods: {
        ...
        analysis(data) {
            httpAction(`/uav/analysis/srp`, data, 'post')
                .then((res) => {
                    if (res.success) {
                        if (res.result !== null) {
        ...
        init() {
            ...
            httpAction(`/uav/uavTaskItem/queryByTypeAndTask?taskId=${taskId}&type=7`, {}, 'get')
                .then((res) => {
                    if (res.success) {
