<template>
  <a-card :bordered="false">
    ...
    <uav-path-modal ref="modalForm" @ok="modalFormOk"></uav-path-modal>
  </a-card>
</template>
...
<script>
  ...
  import UavPathModal from './modules/UavPathModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/uav/uavPath/list",
          delete: "/uav/uavPath/delete",
          deleteBatch: "/uav/uavPath/deleteBatch",
          exportXlsUrl: "/uav/uavPath/exportXls",
          importExcelUrl: "uav/uavPath/importExcel",
